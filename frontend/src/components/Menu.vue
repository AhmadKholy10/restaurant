<template>
            ...
            <div class="col-lg-6 col-12">
                <div class="ratio ratio-1x1">
                    <video autoplay="" loop="" muted="" class="custom-video" poster="">
                        <source src="../../public/assets/videos/pexels-mike-jones-9046237.mp4" type="video/mp4">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-3 col-md-6 col-12 mb-4">
                <div class="team-block-wrap">
                    ...
                    <div class="team-block-image-wrap">
                        <img src="../../public/assets/images/team/portrait-elegant-old-man-wearing-suit.jpg" class="team-block-image img-fluid" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-12 mb-4">
                <div class="team-block-wrap">
                    ...
                    <div class="team-block-image-wrap">
                        <img src="../../public/assets/images/team/cute-korean-barista-girl-pouring-coffee-prepare-filter-batch-brew-pour-working-cafe.jpg" class="team-block-image img-fluid" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-12 mb-4">
                <div class="team-block-wrap">
                    ...
                    <div class="team-block-image-wrap">
                        <img src="../../public/assets/images/team/small-business-owner-drinking-coffee.jpg" class="team-block-image img-fluid" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="team-block-wrap">
                    ...
                    <div class="team-block-image-wrap">
                        <img src="../../public/assets/images/team/smiley-business-woman-working-cashier.jpg" class="team-block-image img-fluid" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="timeline">
                    ...
                    <div class="timeline-content">
                        <div class="reviews-block">
                            <div class="reviews-block-image-wrap d-flex align-items-center">
                                <img src="../../public/assets/images/reviews/young-woman-with-round-glasses-yellow-sweater.jpg" class="reviews-block-image img-fluid" alt="">
                ...
                <div class="timeline-container timeline-container-right">
                    <div class="timeline-content">
                        <div class="reviews-block">
                            <div class="reviews-block-image-wrap d-flex align-items-center">
                                <img src="../../public/assets/images/reviews/senior-man-white-sweater-eyeglasses.jpg" class="reviews-block-image img-fluid" alt="">
                ...
                <div class="timeline-container timeline-container-left">
                    <div class="timeline-content">
                        <div class="reviews-block">
                            <div class="reviews-block-image-wrap d-flex align-items-center">
                                <img src="../../public/assets/images/reviews/young-beautiful-woman-pink-warm-sweater-natural-look-smiling-portrait-isolated-long-hair.jpg" class="reviews-block-image img-fluid" alt="">
  ...
  <script>
    /* eslint-disable */
import {jqueryFunction} from '../../public/assets/js/jquery-min.js';
import { test } from '../../public/assets/js/jquery-sticky';
import {testBootstrap} from '../../public/assets/js/bootstrap.min';
import {testVegas} from '../../public/assets/js/vegas-min';
